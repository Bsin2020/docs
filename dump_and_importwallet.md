...
```dumpwallet /Users/Your_UserName/Desktop/my-old-wallet.txt```

For example for Windows;

```dumpwallet C:\\Users\\Your_UserName\\Desktop\\my-old-wallet.txt```
...
```importwallet /Users/Your_UserName/Desktop/my-old-wallet.txt```

For example for Windows;

```importwallet C:\\Users\\Your_UserName\\Desktop\\my-old-wallet.txt```
